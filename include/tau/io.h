...
namespace tau
{
    ...
    namespace io
    {
        ...
        public:
            ...
            virtual void event( ui, newev::Event& ) = 0;
    ...
    //             : Event( result ), m_time( options.def( options::Msec, 0 ), options.def( options::Usec, 0 ) ), m_custom( NULL )
    //         {
    //             ENTER();
    //         }
    //
    //         Timer( Result& result, const Time& time )
    //             : Event( result ), m_time( time ), m_custom( NULL )
    //         {
    //             ENTER();
    //         }
    //
